  ...
  return (
    <>
      <style>{`
        ...
        .nav-logo-name {
          font-family: 'Plus Jakarta Sans', sans-serif;
          font-weight: 700; font-size: 17px; color: #0f172a; letter-spacing: -0.3px;
        }
        .nav-links { display: flex; align-items: center; gap: 2px; }
        .nav-link {
          position: relative; padding: 7px 16px; font-size: 14px; font-weight: 500;
        ...
        .nav-btn-logout {
          padding: 8px 16px; border: 1.5px solid #e2e8f0; border-radius: 100px;
        ...
        .nav-dashboard-link {
          font-size: 13px; font-weight: 600; color: #0d9488; text-decoration: none;
          padding: 8px 16px; background: rgba(13,148,136,0.08);
          border-radius: 100px; transition: background 0.2s; margin-left: 12px;
        }
        .nav-dashboard-link:hover { background: rgba(13,148,136,0.15); }
        .burger-btn {
          display: none; background: none; border: 1.5px solid #e2e8f0;
          border-radius: 9px; padding: 8px 10px; color: #374151;
          cursor: pointer; font-size: 16px; transition: border-color 0.2s;
        }
        .burger-btn:hover { border-color: #0d9488; color: #0d9488; }
        .mobile-menu {
          background: white; border-top: 1px solid #f1f5f9;
          padding: 12px 20px 20px; box-shadow: 0 16px 40px rgba(0,0,0,0.08);
        }
        .mobile-nav-link {
        ...
        .mobile-nav-link:hover, .mobile-nav-link.active { background: #f0fdf4; color: #0d9488; }
        .mobile-divider { height: 1px; background: #f1f5f9; margin: 10px 0; }
        .mobile-auth-btn {
        ...
        .mobile-auth-btn.login { background: #0d9488; color: white; box-shadow: 0 4px 14px rgba(13,148,136,0.25); }
      ...
      <nav className={`nav-root ${scrolled ? 'scrolled' : 'top'}`}>
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            {/* Visible UNIQUEMENT si connectée */}
            {isAuthenticated && (
